...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var array
     */
    protected $template_dir = array('./web/smarty/tarea/templates/');
     ...
     * @var string
     */
    protected $compile_dir = './web/smarty/tarea/cache/';
     ...
     * parámetro para comprobar las rutas 
     *  1 subir directorio
     *  0 directorio por defecto 
     */
    public function __construct($parametro)
    {
        ...
        // Verifica los directorios predeterminados para sobrecargar
         if($parametro==0){
             $this->template_dir = './web/smarty/tarea/templates/';
             $this->compile_dir = './web/smarty/tarea/cache/';
         }else{
             $this->template_dir = '../web/smarty/tarea/templates/';
             $this->compile_dir = '../web/smarty/tarea/cache/';
         }
